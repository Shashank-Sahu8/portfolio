      ...
      child: ListView(
        children: [UserAccountsDrawerHeader(
              ...
              currentAccountPicture: CircleAvatar(
                backgroundColor: Colors.white70,
                backgroundImage: AssetImage('assets/appd7.png'),
              ),
            decoration: BoxDecoration(
              color:const Color(000000),
              image: new DecorationImage(image: AssetImage('assets/appd8.webp'),fit: BoxFit.cover,colorFilter: new ColorFilter.mode(Colors.black.withOpacity(0.5), BlendMode.darken),),
            ),
          ),
          ListTile(
