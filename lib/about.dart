            ...
            child: new Column(
              children: [
                Padding(
                  ...
                  child: new Center(
                    child: new Text("About Me",style: TextStyle(fontFamily: 'PermanentMarker-Regular',fontSize: 40),),
                  ),
                ),
                new Center(
                  child: Padding(
